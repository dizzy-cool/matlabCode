...
plot(1:30,output_test(31:60),'r-^','MarkerSize',15,'MarkerFaceColor','r','LineWidth',2)
hold on
plot(1:30,predict_BP(31:60),'b--o','MarkerSize',15,'LineWidth',2)% ANN
...
plot(1:30,output_test(31:60),'r-^','MarkerSize',15,'MarkerFaceColor','r','LineWidth',2)
hold on
plot(1:30,predict_GA_ANN(31:60),'b--o','MarkerSize',15,'LineWidth',2)
...
plot(1:30,output_test(31:60),'r-^','MarkerFaceColor','r','MarkerSize',15,'LineWidth',2)
hold on
plot(1:30,predict_GASVM(31:60),'b--o','MarkerSize',15,'LineWidth',2)
legend('Actual data','Forecast data')
xlabel('Label')
ylabel('Width/mm')
...
plot(1:30,output_test(31:60),'r-^','MarkerSize',15,'MarkerFaceColor','r','LineWidth',2)
hold on
plot(1:30,predict_SVM(31:60),'b--o','MarkerSize',15,'LineWidth',2)
legend('Actual data','Forecast data')
xlabel('Label')
ylabel('Width/mm')
...
predict_SVM24 =xlsread('RMC_CALC_WIDTHTAGET_FOR_BP_train20000.csv',1,'B2:B20001');
figure('name','24 hour ')
plot(1:684,predict_SVM24(1:684),'r-^','MarkerSize',3,'MarkerFaceColor','r','LineWidth',0.3)
legend('Forecast width data')
xlabel('Label')
ylabel('Width/mm')
% string_SVM= {'SVM-forecast result';
%            ['mse = ' num2str(14.4575*10^(-5)) ' R^2 = ' num2str(0.6545)]};
